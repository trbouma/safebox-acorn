...
Acorn is the reusable sovereign wallet and private-record component extracted
from Safebox. It should remain small, installable, and product-neutral. Safebox
and other applications may depend on Acorn, but Acorn should not depend on
Safebox application concepts.
...
- Provide a stable Python API and CLI for wallet, record, relay, and payment
  operations.
