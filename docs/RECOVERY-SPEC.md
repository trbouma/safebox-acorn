...
For wallets generated by Acorn, the offline mnemonic is 12 words by default or
24 words when initialization uses `acorn init --words 24`.
...
Both valid 12-word and 24-word Acorn offline mnemonics recover through this
same command. Phrase length changes the amount of original BIP39 entropy, not
the downstream Acorn derivation contract.
